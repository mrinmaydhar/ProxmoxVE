...
# upstream   https://github.com/mrinmaydhar/ProxmoxVE.git (fetch)
# upstream   https://github.com/mrinmaydhar/ProxmoxVE.git (push)
```
...
print_info "Upstream: https://github.com/mrinmaydhar/ProxmoxVE"
echo ""
